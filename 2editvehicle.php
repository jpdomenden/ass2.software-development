...
<?php
$errors = [];
$Vehicle_id = $Make = $Model = $Year = $Stock_number= $Doors = $Engine = $Color = $Mileage = $Seats = $Safety_rating = $Price = ""; 
...
if(isset($_POST['Edit'])){
  ...
  $Price = $_POST['Price']; 
$sql = "update `vehicles` set (`Vehicle_id`, `Make`, `Model`, `Year`, `Stock_number`, `Doors`, `Engine`, `Color`, `Mileage`, `Seats`, `Safety_rating`, `Price`) 
...
<form style="width:50%; border:1px solid black;" method="POST">
  ...
  <button name="Edit"> Edit vehicle</button>
